...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  RIYAN  "$i"                    "
echo $i""$pu"  WhatsApp:  0895632370150"$i"                "
echo $i""$pu"  GMAIL   :  riyan23042002@gmail.com"$i"     "
echo $i""$pu"  YOUTUBE :  YouTube Apriyan Pradana"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Riyan"
echo $ku"YouTube  :"$i" YouTube ApriyanPradana"
echo $ku"WhatsApp :"$i" 0895632370150"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE ApriyanPradana }"
exit
fi
